...
* Remember to limit basket weights to 20 kg to prevent injuries and practice safe [lifting techniques](aditional_references.qmd#lifting).
...
If a large shark is caught please follow the [MACE protocol](other manuals/Shark_protocol_20230428.pdf) for its release. Remember to collect ___ measurements if possible.
...
*	Remove the SBE39 plus and [download](#SBE-download).
